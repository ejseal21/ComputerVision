...
while(True):
	...
	img2, contours, hierarchy = cv2.findContours(openMat, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
	...
	for i in range(len(contours)):
		...
		if (y-e>0 and x-e>0):
			...
			# cv2.rectangle(frame, (x-e,y-e), (x+e,y+e), (0,0,255), 3)
